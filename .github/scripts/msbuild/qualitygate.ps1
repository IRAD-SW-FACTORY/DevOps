...
$SONAR_BASIC_TOKEN = if ($null -ne $env:SONAR_BASIC_TOKEN) { $env:SONAR_BASIC_TOKEN } else { "c3FhX2Y1MDVhYTA4YTRhNmJmNzI0MDI0YThmZDBkNTBhN2RiN2RkYWQyNzA6" };
...
$headers.Add("Authorization", "Basic ${SONAR_BASIC_TOKEN}")
